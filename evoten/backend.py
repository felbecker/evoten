...
class Backend():
    def __init__(self):
        ...
        self.wrapped_backend : Backend = NullBackend()
    ...
    def make_transition_probs(self, rate_matrix, distances, equilibrium):
        ...
        Args:
            ...
            equilibrium: Equilibrium distribution of shape (..., d). Should be
    ...
    def ensure_tensor(self, x):
        """
        Ensures that x is a tensor of the backend's native type.
        """
        return self.wrapped_backend.ensure_tensor(x)
